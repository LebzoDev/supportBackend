 ...
 */
class getSecurity_Authentication_Provider_Guard_ApiClientService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.authentication.provider.guard.api_client' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authentication.provider.guard.api_client'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () use ($container) {
        ...
        }, 1), ($container->privates['security.user.provider.concrete.app_client_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppClientProviderService')), 'api_client', ($container->privates['security.user_checker'] ?? ($container->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), ($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')));
    }
}
