...
class App_KernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AdminSystemRepository' => ['privates', 'App\\Repository\\AdminSystemRepository', 'getAdminSystemRepositoryService', true],
            'App\\Repository\\AgencePartenaireRepository' => ['privates', 'App\\Repository\\AgencePartenaireRepository', 'getAgencePartenaireRepositoryService', true],
            'App\\Repository\\ClientRepository' => ['privates', 'App\\Repository\\ClientRepository', 'getClientRepositoryService', true],
            'App\\Repository\\CompteAgencePartenaireRepository' => ['privates', 'App\\Repository\\CompteAgencePartenaireRepository', 'getCompteAgencePartenaireRepositoryService', true],
            ...
            'App\\Repository\\AdminSystemRepository' => '?',
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T3FZBR5jG-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s8rREy7Bns', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5WDepeNc+0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('70p7kc0dhi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bQ103HN3Hn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('2BvDBheNWt', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VKuae5Ffb+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JJSbphmyjX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yVqJIr-zeb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zNvCOH9EYX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vtEz9QwJHB', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U4mk5ZMCND', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['security.authentication.provider.dao.login_client'] ?? $this->load('getSecurity_Authentication_Provider_Dao_LoginClientService'));
            yield 3 => ($this->privates['security.authentication.provider.anonymous.login_client'] ?? ($this->privates['security.authentication.provider.anonymous.login_client'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 4 => ($this->privates['security.authentication.provider.guard.api'] ?? $this->load('getSecurity_Authentication_Provider_Guard_ApiService'));
            yield 5 => ($this->privates['security.authentication.provider.anonymous.api'] ?? ($this->privates['security.authentication.provider.anonymous.api'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 6 => ($this->privates['security.authentication.provider.guard.api_client'] ?? $this->load('getSecurity_Authentication_Provider_Guard_ApiClientService'));
            yield 7 => ($this->privates['security.authentication.provider.anonymous.api_client'] ?? ($this->privates['security.authentication.provider.anonymous.api_client'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
        }, 8), true);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.api_client' => ['privates', 'security.firewall.map.context.api_client', 'getSecurity_Firewall_Map_Context_ApiClientService', true],
            ...
            'security.firewall.map.context.login_client' => ['privates', 'security.firewall.map.context.login_client', 'getSecurity_Firewall_Map_Context_LoginClientService', true],
        ], [
            'security.firewall.map.context.api' => '?',
            'security.firewall.map.context.api_client' => '?',
            'security.firewall.map.context.dev' => '?',
            'security.firewall.map.context.login' => '?',
            'security.firewall.map.context.login_client' => '?',
        ]), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.login_client' => ($this->privates['.security.request_matcher.h9WSUM4'] ?? ($this->privates['.security.request_matcher.h9WSUM4'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login_check_client')));
            ...
            yield 'security.firewall.map.context.api_client' => ($this->privates['.security.request_matcher.h9WSUM4'] ?? ($this->privates['.security.request_matcher.h9WSUM4'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login_check_client')));
        }, 5));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.login_client._indexed_authenticators' => [

            ],
            'security.api._indexed_authenticators' => [

            ],
            'security.api_client._indexed_authenticators' => [
