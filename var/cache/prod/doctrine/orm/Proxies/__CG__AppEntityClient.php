...
class Client extends \App\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'username', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'nomComplet', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'CNI', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'telephone'];
        }
     ...
     * {@inheritDoc}
     */
    public function setUsername(string $username): \App\Entity\Client
    {
